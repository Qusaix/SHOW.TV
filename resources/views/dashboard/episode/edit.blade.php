...
<div class="main-panel">
    <div class="content-wrapper">
      <div class="page-header">
        <h3 class="page-title"> Edite {{ $episode->title }} Episode </h3>
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="card-block">
                    <form class="form-horizontal m-t-sm" action="{{ route('dashboard.episodes.update',$episode->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        ...
                                        <input value="{{ old('title') ? old('title') : $episode->title }}" class="form-control input-lg" type="text" id="mega-username" name="title" placeholder="Enter The Title"  />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        ...
                                        <textarea  name="description" placeholder="Enter The Description" class="form-control" id="exampleFormControlTextarea1" rows="3">{{ old('description') ? old('description') : $episode->description}}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        ...
                                        <input value="{{ old('duration') ?  old('duration') : $episode->duration }}" class="form-control input-lg" type="number" id="mega-username" name="duration" placeholder="Enter The Duration min"  />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-5">
